# Generated by Django 3.2.7 on 2021-11-10 18:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Room_Name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.floors')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date_Field', models.DateField()),
                ('Floor_Name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.rooms')),
            ],
        ),
        migrations.CreateModel(
            name='PowerConsMachine',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, unique=True)),
