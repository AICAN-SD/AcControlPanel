    ...
    return (
      <div>
          ...
          <>
            ...
            {floor.rooms!==undefined && floor.rooms.map((room,indx)=>{
              return (
                <>
                <div className='rectangle'>
              ...
              <Row >
                ...
                {room.machines!==undefined && room.machines.map((machine,indxx)=>{
                  return (
                    <>

                         <ControlPanelMachineCard machineData={machine} floor={floor.floor}></ControlPanelMachineCard>
